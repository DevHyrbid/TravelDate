...
class SavedGroupCell: UITableViewCell {
    ...
    private func setup() {
        ...
        bookmarkBtn.removeFromSuperview()
        bookmarkBtn.removeFromSuperview()

            let bookmark = UIButton(type: .custom)
            bookmark.translatesAutoresizingMaskIntoConstraints = false

            bookmark.setBackgroundImage(
                UIImage(named: "imgBookmark"),
                for: .normal
            )

            bookmark.backgroundColor = .clear
            bookmark.adjustsImageWhenHighlighted = false
            bookmark.adjustsImageWhenDisabled = false
            ...
            cardView.addSubview(bookmark)

            self.bookmarkBtn.removeFromSuperview()
        ...
        NSLayoutConstraint.activate([
            ...
            bookmark.topAnchor.constraint(equalTo: cardView.topAnchor, constant: 12),
                  bookmark.trailingAnchor.constraint(equalTo: cardView.trailingAnchor, constant: -14),

                  bookmark.widthAnchor.constraint(equalToConstant: 40),
                  bookmark.heightAnchor.constraint(equalToConstant: 40),
            ...
            membersRow.heightAnchor.constraint(equalToConstant: 46),
