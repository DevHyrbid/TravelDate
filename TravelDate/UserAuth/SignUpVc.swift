...
class SignUpVc: UIViewController, UITextFieldDelegate {
    ...
    private let nameLabel = SignUpVc.makeLabel("Full Name")
    private let emailLabel = SignUpVc.makeLabel("Email")
    private let passwordLabel = SignUpVc.makeLabel("Password")
